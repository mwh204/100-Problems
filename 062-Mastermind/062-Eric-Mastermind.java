...
public class mastermindGame {
	...
	public static void main(String[] args) {
		...
		System.out.println("Guess a sequence of 4 digits and try to solve the puzzle. You have 10 guesses.");
		int guesses = 0;
		String currentGuess;
		...
		while (guesses < 10){
			...
			if (Integer.parseInt(currentGuess) == Integer.parseInt(answer)){
